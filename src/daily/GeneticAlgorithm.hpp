...
namespace daily_solver
{
  /**
   * @struct GAConfig
   * @brief Configuration parameters for the Genetic Algorithm (GA).
   */
  struct GAConfig
  {
    ...
    int crossover;          /**< Identifier for the crossover operator to use (0: Order1, 1: Order2, 2: Position, 3: Edge, 4: Edge, 5: Partially Mapped). */
  ...
  public:
    /**
     * @brief Constructs the Genetic Algorithm solver.
     *
     ...
     */
    GeneticAlgorithm(GAConfig config, const routing::DecoderInterface &decoder);

    /**
     * @brief Executes the Genetic Algorithm for a single day.
     *
