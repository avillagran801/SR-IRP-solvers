...
namespace solvers
{
   ...
   * @param selection_method Identifier for the parent selection strategy (0: Tournament, 1: Roulette, 2: Sigma, 3: Boltzmann) (default 2).
   ...
   * @param crossover Identifier for the crossover operator to use (0: Order1, 1: Order2, 2: Position, 3: Edge, 4: Partially Mapped) (default 4).
